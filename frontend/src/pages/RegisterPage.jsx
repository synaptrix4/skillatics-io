...
import { Loader2, ArrowRight, ShieldCheck, Mail, User } from 'lucide-react'
...
export default function RegisterPage() {
    ...
    function nextStep() {
        ...
        requestOtp({ email: form.email, name: form.name, purpose: 'register' })
            .then(() => {
                setInfo('OTP sent to your email. Check your spam folder if you don\'t see it.')
                setStep(2)
            })
                        ...
                        <motion.div variants={containerVariants} className="flex flex-col items-center text-center space-y-8">
                            ...
                            <motion.div variants={itemVariants} className="space-y-3">
                                ...
                                <p className="text-slate-500 font-medium">
                                    Join the intelligent assessment ecosystem
                                </p>
                            </motion.div>
                                    ...
                                    <>
                                        <motion.div variants={itemVariants} className="relative">
                                            ...
                                            <input
                                                ...
                                                className="w-full pl-11 pr-4 py-4 bg-white/60 border border-slate-200 rounded-2xl text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-4 focus:ring-orange-500/20 focus:border-orange-500 transition-all duration-300 shadow-sm"
                                                value={form.name}
                                    ...
                                    >
                                        ...
                                        <span className="relative flex items-center justify-center gap-2">
                                            {loading ? (
                                                ...
                                                <>
                                                    {step === 1 ? 'Continue with Email' : 'Create Account'}
                            ...
                            <motion.div variants={itemVariants} className="w-full pt-6 border-t border-slate-100 text-center">
                                ...
                                <Link to="/login" className="text-sm font-bold text-orange-600 hover:text-orange-700 transition-colors">
                                    Sign In Instead
                                </Link>
                            </motion.div>

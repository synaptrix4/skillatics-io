...
import { Play, Clock, Target, CheckCircle2, XCircle, Award, RotateCcw, Maximize, AlertCircle, TrendingUp } from 'lucide-react'
...
export default function Test() {
	...
	const TOTAL_QUESTIONS = 12 // target UI like the reference; adjust if needed
	...
	function finishEarly() {
		setStatus('complete')
		setResult(r => r || { score: null, correctQuestions: null, totalQuestions: navigatorState.filter(Boolean).length })
	}
						...
						<div className="p-6 max-h-[calc(100vh-280px)] overflow-auto">
							...
							<div className="mt-8 space-y-3">
								{question.options.map((opt, idx) => (
									<label 
										key={opt} 
										className={`flex cursor-pointer items-center gap-4 rounded-lg border-2 px-5 py-4 transition-all ${
											selected === opt 

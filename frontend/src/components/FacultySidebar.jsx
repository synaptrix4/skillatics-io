...
export default function FacultySidebar({ isOpen, onClose }) {
    ...
    const navItems = [
        { to: "/faculty", text: "Dashboard", icon: LayoutDashboard, exact: true },
        { to: "/faculty/profile", text: "My Profile", icon: User },
    ];
                ...
                <div className="flex items-center justify-between p-6 border-b border-slate-100">
                    <Link to="/" className="flex items-center gap-3" onClick={onClose}>
                        ...
                        <div>
                            ...
                            <p className="text-xs font-semibold text-orange-600">Faculty Portal</p>
                        </div>
                    </Link>
    ...
    return (
        <li>
            ...
            >
                ...
                {active && (
                    <motion.div
                        layoutId="facultySidebarActiveTab"
